...
import { Youtube, Sparkles, Video, CheckCircle, Flame, Scissors, Download, RefreshCw } from 'lucide-react';
...
export default function Home() {
  ...
  // Remplace cette URL par l'URL exacte de ton backend Railway
